...
export default class instructionsScreen extends Component {
  ...
  async getAudio () {  
    ...
    let fileURL = '';    
    const text = 'الْاِنْتِقَالْ بَيْنَ الصَّفْحَاتْ، لِلْاِنْتِقَالِ بَيْنَ الصَّفْحَاتْ، فَضْلاً قُلْ اِسْمَ الصَّفْحَه.، مِثَالْ،التّقَاريرْ.  التَّعَامُلِ مَعَ الْأَجْهِزَه ، لِلتَّعَامُلِ مَعَ الْأَجْهِزَه، اذْكُرْ اِسْمَ الْأَمْرِ مَتْبُوعًا بِاِسْمِ الْجِهَازْ، مِثَالْ، تَشْغِيلْ النُّورْ، تَعْدِيلْ الْأَنْمَاطْ، لِتَعْدِيلِ النَّمَطِ الصَّبَاحِيِّ أول الْمَسَائِيّْ، اذْكُرْ  اِسْمَ النَّمَطْ، ثُمَّ اِسْمَ الْأَمْرْ مَتْبُوعًا بِاِسْمِ الْجِهَازْ، ثُمَّ الْوَقْتْ بِالسَّاعَاتْ، ثُمَّ الدَّقَائِقْ، وأخيرًا حِفْظْ. مِثَالْ الْوَضْعُ الصَّبَاحِيّْ، تَشْغِيلْ النُّورْ، ثَلاثْه، خِمْسُوونْ، حِفْظْ. لِتَعْدِيلِ نَمَطِ الْخُرُوجِ، أو، الْعَوْدَةِ إِلَى الْمَنْزِلْ، اِسْمَ النَّمَطْ، ثُمَّ اِسْمَ الْأَمْرِ مَتْبُوعًا بِاِسْمِ الْجِهَازْ، وأخيرًا حِفْظْ. مِثَالْ، وَضْعْ الْخُرُوجْ مِنَ الْمَنْزِلْ، تَشْغِيلْ النُّورْ، حِفْظْ.'
