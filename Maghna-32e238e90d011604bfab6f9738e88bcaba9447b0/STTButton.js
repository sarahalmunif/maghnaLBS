...

{
  ...
  console.log("offff")
    ...
    if(transcript == "ست دقائق"){
     ...
     if(transcript == "11 دقيقه"){
       // mins= 11
       routineArr.push(11) 
    }
     if(transcript == "12 دقيقه"){
       // mins= 12
       routineArr.push(12) 
    }
     ...
     if(transcript == "خمسه عشر دقيقه"){
      ...
      //  mins= 19
       ...
       if(transcript == "21 دقيقه"){
       // mins= 21
       routineArr.push(21) 
    }
    if(transcript == "22 دقيقه"){
       // mins= 22
       routineArr.push(22) 
    }
    if(transcript == "23 دقيقه"){
    //mins= 23
       routineArr.push(23) 
    }
    if(transcript == "24 دقيقه"){
       // mins= 24
       routineArr.push(24) 
    }
    if(transcript == "25 دقيقه"){
       // mins= 25
       routineArr.push(25) 
    }
    if(transcript == "26 دقيقه"){
       // mins= 26
       routineArr.push(26) 
    }
    if(transcript == "27 دقيقه"){
       // mins= 27
       routineArr.push(27) 
    }
    if(transcript == "28 دقيقه"){
       // mins= 28
       routineArr.push(28) 
    }
    if(transcript == "29 دقيقه"){
      //  mins= 29
       routineArr.push(29) 
    }
    if(transcript == "30 دقيقه"){
      //  mins= 30
       routineArr.push(30) 
       console.log("33300000");
    }
     if(transcript == "31 دقيقه"){
      //  mins= 31
       routineArr.push(31) 
    }
    if(transcript == "32 دقيقه"){
      //  mins= 32
       routineArr.push(32) 
    }
    if(transcript == "33 دقيقه"){
      //  mins= 33
       routineArr.push(33) 
    }
    if(transcript == "34 دقيقه"){
       // mins= 34
       routineArr.push(34) 
    }
    if(transcript == "35 دقيقه"){
      //  mins= 35
       routineArr.push(35) 
    }
    if(transcript == "36 دقيقه"){
      //  mins= 36
       routineArr.push(36) 
    }
    if(transcript == "37 دقيقه"){
      //  mins= 37
       routineArr.push(37) 
    }
    if(transcript == "38 دقيقه"){
      //  mins= 38
       routineArr.push(38) 
    }
    if(transcript == "39 دقيقه"){
      //  mins= 39
       routineArr.push(39) 
    }
    if(transcript == "40 دقيقه"){
      //  mins= 40
       routineArr.push(40) 
    }
    if(transcript == "41 دقيقه"){
      //  mins= 41
       routineArr.push(41) 
    }
     if(transcript == "42 دقيقه"){
      //  mins= 42
       routineArr.push(42) 
    }
     if(transcript == "43 دقيقه"){
      //  mins= 43
       routineArr.push(43) 
    }
     if(transcript == "44 دقيقه"){
      //  mins= 44
       routineArr.push(44) 
    }
     if(transcript == "45 دقيقه"){
      //  mins= 45
       routineArr.push(45) 
    }
     if(transcript == "46 دقيقه"){
       // mins= 46
       routineArr.push(46) 
    }
     if(transcript == "47 دقيقه"){
      //  mins= 47
       routineArr.push(47) 
    }
     if(transcript == "48 دقيقه"){
      //  mins= 48
       routineArr.push(48) 
    }
     if(transcript == "49 دقيقه"){
      //  mins= 49
       routineArr.push(49) 
    }
     if(transcript == "50 دقيقه"){
      //  mins= 50
       routineArr.push(50) 
    }
     if(transcript == "51 دقيقه"){
      //  mins= 51
       routineArr.push(51) 
    }
      if(transcript == "52 دقيقه"){
      //  mins= 52
       routineArr.push(52) 
    }
      if(transcript == "53 دقيقه"){
      //  mins= 53
       routineArr.push(53) 
    }
      if(transcript == "54 دقيقه"){
      //  mins= 54
       routineArr.push(54) 
    }
      if(transcript == "55 دقيقه"){
      //  mins= 55
       routineArr.push(55) 
    }
      if(transcript == "56 دقيقه"){
      //  mins= 56
       routineArr.push(56) 
    }
      if(transcript == "57 دقيقه"){
      //  mins= 57
       routineArr.push(57) 
    }
      if(transcript == "58 دقيقه"){
      //  mins= 58
       routineArr.push(58) 
    }
      if(transcript == "59 دقيقه"){
      //  mins= 59
       routineArr.push(59) 
    }
    if(transcript == "تماما"){
